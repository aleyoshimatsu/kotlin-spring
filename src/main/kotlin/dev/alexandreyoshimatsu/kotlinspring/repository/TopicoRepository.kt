...
interface TopicoRepository : JpaRepository<Topico, Long> {
    ...
    @Query("SELECT new dev.alexandreyoshimatsu.kotlinspring.dto.TopicoPorCategoriaDto(curso.categoria, count(t)) FROM Topico t JOIN t.curso curso GROUP BY curso.categoria")
